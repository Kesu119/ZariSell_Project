                  ...
                  <ul className="dropdown1-menu">
                    ...
                    <li>
                      ...
                      {openDropdown.goldZari && (
                        <ul className="dropdown2-menu">
                          <li><a className="dropdown2-item" href="#" style={{ color: "black" }}>Dark Gold Shade 1</a></li>
                          <li><a className="dropdown2-item" href="#" style={{ color: "black" }}>Dark Gold Shade 2</a></li>
                        </ul>
                      )}
                    </li>
                      {/* product inside 2 */}
                    <li>
                      ...
                      {openDropdown.lightZari && (
                        <ul className="dropdown2-menu">
                          <li><a className="dropdown2-item" href="#" style={{ color: "black" }}>light Gold Shade 1</a></li>
                          <li><a className="dropdown2-item" href="#" style={{ color: "black" }}>light Gold Shade 2</a></li>
                        </ul>
                      )}
                    </li>
                    ...
                    <li>
                      ...
                      {openDropdown.crapZari && (
                        <ul className="dropdown2-menu">
                          <li><a className="dropdown2-item" href="#" style={{ color: "black" }}>crap Shade 1</a></li>
                          <li><a className="dropdown2-item" href="#" style={{ color: "black" }}>crap Shade 2</a></li>
                        </ul>
                      )}
                    </li>
                    ...
                    <li>
                      ...
                      {openDropdown.silverZari && (
                        <ul className="dropdown2-menu">
                          <li><a className="dropdown2-item" href="#" style={{ color: "black" }}>silver Shade 1</a></li>
                          <li><a className="dropdown2-item" href="#" style={{ color: "black" }}>silver Shade 2</a></li>
                        </ul>
                      )}
                    </li>
                    ...
                    <li>
                      ...
                      {openDropdown.coneZari && (
                        <ul className="dropdown2-menu">
                          <li><a className="dropdown2-item" href="#" style={{ color: "black" }}>cone Shade 1</a></li>
                          <li><a className="dropdown2-item" href="#" style={{ color: "black" }}>cone Shade 2</a></li>
                        </ul>
                      )}
                    </li>
